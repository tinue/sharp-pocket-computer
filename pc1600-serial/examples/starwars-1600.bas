...
100 XPOKE AD,72,118,74,0,88,119,90,0,106,77,251,181,255,1,14,251,181,255,17,30,64
110 XPOKE AD+21,80,136,14,154
115 IF DERETURN
...
250 BEEP 2,1,320:W=2^(6-1)+2^(5-1):X=15+A*24:GCURSOR X:V=(POINT X)OR W:GPRINT V
260 NEXT I
...
350 XCALL AD:C=C+1:IF C=3AND DE=0THEN 500
